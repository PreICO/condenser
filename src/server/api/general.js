...
export default function useGeneralApi(app) {
    ...
    router.post('/accounts', koaBody, function*() {
        ...
        try {
            ...
            //     throw new Error("Only one Earthshare account per user is allowed in order to prevent abuse");
            // }
            ...
            if (same_ip_account) {
                ...
                if (minutes < 10) {
                    ...
                    throw new Error(
                        'Only one Earthshare account allowed per IP address every 10 minutes'
                    );
                }
            }
