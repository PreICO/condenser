...
></SCRIPT>">'><SCRIPT>alert(String.fromCharCode(88,83,83))</SCRIPT>`,
    ...
    `<SCRIPT SRC=https://earthshare.network/xss.js></SCRIPT>`,

    `onnerr w/ clearly invalid img: <img src="awesome.jpg" onerror="alert('xss')" /><br />
good image: <img src="https://earthshare.network/images/press/press-theblkchn.png" onerror="alert('xss')" /><br />
good url, bad img: <img src="https://earthshare.network/testing-does-not-exist.png" onerror="alert('xss')" />
