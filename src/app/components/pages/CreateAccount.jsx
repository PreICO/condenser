                ...
                <div className="row">
                    <div className="column">
                        ...
                        <div className="callout alert">
                            <p>
                                Membership to Earthshare.network is now under
                    ...
                    <div className="column">
                        ...
                        <div className="callout alert">
                            <p>
                                ...
                                <a href="mailto:support@earthshare.network">
                                    support@earthshare.network
                                </a>{' '}
        ...
        return (
            <div>
                <div className="CreateAccount row">
                    <div className="column">
                        <h4>
                            Please read the Earthshare Rules and fill in the
                            form below to create your Earthshare account
                        </h4>
                        {showRules ? (
                            <div className="CreateAccount__rules">
                                <p>
                                    The first rule of Earthshare is: Do not lose
                                    your password.<br />
                                    The second rule of Earthshare is: Do{' '}
                                    <strong>not</strong> lose your password.<br
                                    />
                                    The third rule of Earthshare is: We cannot
                                    ...
                                    without knowing the password. Earthshare is
                                    a new model, entirely unlike other sites on
